...
怎么跨过用户态、内核、再到 DSP？** 这一篇看内核模块 [audio-kernel-ar](../../../audio-kernel-ar/)，
...
内核 GPR 是一个 **rpmsg 驱动**（[gpr-lite.c](../../../audio-kernel-ar/ipc/gpr-lite.c)）。
...
收包走 rpmsg 回调 `gpr_callback`（[gpr-lite.c:252](../../../audio-kernel-ar/ipc/gpr-lite.c#L252)），
...
（[audio-pkt.c](../../../audio-kernel-ar/ipc/audio-pkt.c)）注册的字符设备。它提供
...
（[spf-core.c:159](../../../audio-kernel-ar/dsp/spf-core.c#L159)）用一条 GPR 命令探测：
...
`msm_audio_ion.c`（[msm_audio_ion.c](../../../audio-kernel-ar/dsp/msm_audio_ion.c)）分配的：
