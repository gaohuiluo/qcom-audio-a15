...
APM（Audio Processing Manager，[fwk/spf/apm/](../../audioreach-engine/fwk/spf/apm/)）
是 DSP 上第一个收到 GPR 命令的服务。它在 GPR 注册一个固定 port，处理一整套图命令
（[apm_api.h](../../audioreach-engine/fwk/spf/apm/../../api/apm/apm_api.h)）：
...
[apm_cmd_sequencer.c:423](../../audioreach-engine/fwk/spf/apm/core/src/apm_cmd_sequencer.c#L423)）。
...
[fwk/spf/containers/](../../audioreach-engine/fwk/spf/containers/) 提供了四种容器，
针对不同用例特性：
...
（[containers/olc/](../../audioreach-engine/fwk/spf/containers/olc/)）作为远端子图的
...
封装所有模块（[interfaces/module/capi/capi.h](../../audioreach-engine/fwk/spf/interfaces/module/capi/capi.h)），
...
[modules/](../../audioreach-engine/modules/) 下是内建模块，音频工程师一眼就懂：
...
`capi_init`？——**AMDB（AudioReach Module Database，[fwk/spf/amdb/](../../audioreach-engine/fwk/spf/amdb/)）**。
