...
入口在 [Pal.cpp:176](../audioreach-pal/Pal.cpp#L176)。它做三件事：拿到
...
`Stream::create`（[Stream.cpp:75](../audioreach-pal/stream/src/Stream.cpp#L75)）
...
在 [StreamPCM.cpp:117](../audioreach-pal/stream/src/StreamPCM.cpp#L117) 附近，
构造函数就把两个核心协作对象建好：
...
串行化图操作（[StreamPCM.cpp:471-503](../audioreach-pal/stream/src/StreamPCM.cpp#L471-L503)）：
...
| 仓库 | 你会在这里找到 |
|------|----------------|
| [audioreach-pal](../audioreach-pal/) | `Pal.cpp`、`stream/`、`session/`、`device/`、`resource_manager/`、`ipc/` |
| [agm](../../agm/) | `service/src/agm.c`、`session_obj.c`、`graph.c`；`plugins/tinyalsa` |
| [audioreach-graphservices/gsl](../audioreach-graphservices/gsl/) | `gsl_main.c`、`gsl_graph.c`、`gsl_subgraph.c`、`gsl_datapath.c` |
| [audioreach-graphservices/acdb](../audioreach-graphservices/acdb/) | ACDB 解析、图/标定数据接口 |
| [audioreach-engine/gpr](../../audioreach-engine/gpr/) | `core/`、`datalinks/gpr_lx`（Linux datalink） |
| [audioreach-engine/fwk/spf](../../audioreach-engine/fwk/spf/) | `apm/`、`containers/`、`modules/`、`amdb/` |
| [audio-kernel-ar](../../../audio-kernel-ar/) | `asoc/`、`dsp/`、`ipc/`、`soc/` |
